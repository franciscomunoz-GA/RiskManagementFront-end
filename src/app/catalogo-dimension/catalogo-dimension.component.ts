...
export class CatalogoDimensionComponent implements OnInit {
 ...
 constructor(public dialog: MatDialog, 
   ...
   //Permisos   
   this.Create = Permiso.ValidarPermiso('crear dimensiones');
   this.Update = Permiso.ValidarPermiso('editar dimensiones');
   this.Delete = Permiso.ValidarPermiso('eliminar dimensiones');
 }
 exportAsXLSX():void {
