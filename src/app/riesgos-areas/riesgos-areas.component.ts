...
displayedColumns: string[] = ['Nombre', 'RiesgoId', 'RiesgoNombre', 'Area', 'Usuario', 'Fecha', 'Editar', 'Deshabilitar', 'Eliminar'];
...
displayedColumns: string[] = ['Numero', 'Nombre','Riesgo', 'Area'];
Tabla = new MatTableDataSource<ImportElement>();
RegistrosTabla:ImportElement[] = []
@ViewChild(MatPaginator, {static: true}) paginator: MatPaginator;
Catalogo = [{'Nombre': '', 'Riesgo': '', 'Area': ''}];
